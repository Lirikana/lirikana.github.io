...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var cheese = readData("cheese");
        res.render('showResults', {results: [color, fruit, animal,car,sports,cheese]});
        console.log([color, fruit, animal,car,sports,cheese]);
    });
    ...
    app.post('/niceSurvey', urlencodedParser, function(req, res){
        ...
        for (var key in json){
            ...
            else if((key === "cheese")&&(json[key].length>=2)){
                for (var item in json[key]){
                    combineCounts(key,json[key][item]);
                }
            }
